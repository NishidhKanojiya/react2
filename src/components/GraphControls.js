  ...
  return (
    <div className="card">
      <div className="flex gap-2 mb-4" style={{ flexWrap: "wrap" }}>
        <button className="btn btn-primary" onClick={onRunAlgorithm} disabled={isRunning}>
          <svg
        ...
        <button className="btn btn-outline" onClick={onCreateCustomGraph} disabled={isRunning}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
        ...
        <button className="btn btn-outline" onClick={onTogglePause} disabled={!isRunning}>
          {isPaused ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        <button className="btn btn-outline" onClick={onStepForward} disabled={!isRunning}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
      ...
      <div className="slider-container mb-6">
        <label htmlFor="speed" className="form-label" style={{ minWidth: "120px" }}>
          Animation Speed:
        </label>
        <input
          id="speed"
